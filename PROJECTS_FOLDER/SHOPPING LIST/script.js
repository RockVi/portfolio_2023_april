...
let list = document.getElementById("innerList");                         // Llista (ul) del DOM
let shoppingList = document.getElementsByClassName("shoppingList");      // Element pare de la llista (div)
